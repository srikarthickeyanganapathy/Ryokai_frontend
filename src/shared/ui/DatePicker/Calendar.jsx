  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          'bg-[var(--accent-cyan)] text-white hover:bg-[var(--accent-cyan)] hover:text-white focus:bg-[var(--accent-cyan)] focus:text-white',
        day_today: 'bg-[var(--bg-subtle)] text-[var(--text-primary)]',
        day_outside:
