...
export function CrewTabs({ activeTab, setActiveTab, tabCounts, sticky = true }) {
  ...
  useEffect(() => {
    if (!tabCounts) return
    // eslint-disable-next-line react-hooks/set-state-in-effect -- intentional: sync displayed counts for count-change animation
  ...
  return (
    <div className={cn('relative pb-px', sticky ? 'sticky top-0 z-20 bg-[var(--bg-base)]/80 backdrop-blur-md' : '')}>
