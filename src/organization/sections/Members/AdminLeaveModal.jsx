          ...
          {isAlone ? (
            <div className="bg-[var(--danger-soft)] border border-[var(--danger-border)] p-4 rounded-[var(--radius-md)]">
              <Text className="text-sm font-medium text-[var(--danger)]">
                Warning: You are the only member in this organization. Exiting will permanently dissolve and delete all its data, teams, and projects.
              </Text>
            </div>
          ) : (
            <div className="space-y-4">
              ...
              {mode === 'transfer' ? (
                ...
                Warning: Irreversible Action: All other members will be removed, and all tasks, teams, and projects under this organization will be permanently deleted.
                  </Text>
                </div>
              )}
            </div>
