...
import { WorkspaceShell, ManagementLayout, ModularToolbar, PageStateContainer } from '@/shared/workspace-framework';
      ...
      >
        ...
        <PageStateContainer
          ...
          emptyConfig={{
            ...
            onAction: canManageAnnouncements ? () => setIsCreateOpen(true) : undefined,
          }}
        >
      ...
      <AnnouncementDrawer
        ...
        onDelete={() => { 
          if (activeAnnouncement) {
            handleDelete(activeAnnouncement.id); 
