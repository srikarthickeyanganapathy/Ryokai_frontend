      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <Card className="border-dashed bg-[var(--bg-elevated)] border-[var(--border-subtle)] opacity-70">
          ...
          <CardContent className="h-[160px] flex flex-col items-center justify-center text-center">
            ...
            <span className="px-2 py-1 bg-[var(--bg-subtle)] border border-[var(--border-subtle)] text-[11px] font-mono rounded text-[var(--text-secondary)]">Not Connected</span>
          </CardContent>
        </Card>
        ...
        <Card className="border-dashed bg-[var(--bg-elevated)] border-[var(--border-subtle)] opacity-70">
          ...
          <CardContent className="h-[160px] flex flex-col items-center justify-center text-center">
            ...
            <span className="px-2 py-1 bg-[var(--bg-subtle)] border border-[var(--border-subtle)] text-[11px] font-mono rounded text-[var(--text-secondary)]">Not Configured</span>
          </CardContent>
        </Card>
        ...
        <Card className="border-dashed bg-[var(--bg-elevated)] border-[var(--border-subtle)] opacity-70">
          ...
          <CardContent className="h-[160px] flex flex-col items-center justify-center text-center">
            ...
            <span className="px-2 py-1 bg-[var(--bg-subtle)] border border-[var(--border-subtle)] text-[11px] font-mono rounded text-[var(--text-secondary)]">Coming Soon</span>
          </CardContent>
        </Card>
      </div>
    </PageShell>
