...
} from '@/features/organization/organizations/hooks/useOrganizations'
  ...
  return (
    <Modal open={isOpen} onOpenChange={onClose}>
      <ModalContent className="sm:max-w-md max-h-[80vh] flex flex-col">
        ...
        <div className="flex border-b border-[var(--color-border-subtle)] px-6 pt-2 gap-6">
          <button
            type="button"
        ...
        <div className="flex-1 overflow-y-auto space-y-6 min-h-0 pr-2 pt-4 custom-scrollbar">
