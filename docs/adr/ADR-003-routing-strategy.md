...
## Context
Ryokai requires a routing system that supports layout shells (Main vs Auth), protected routes, and complex nested views without re-rendering the entire DOM tree.
